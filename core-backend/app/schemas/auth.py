...
class TwoFactorVerifyRequest(BaseModel):
    ...
    backup_code: Optional[str] = Field(None, description="Backup code (if verification code fails)")
...
class RegisterRequest(BaseModel):
    ...
    accept_terms: bool = Field(..., description="Whether user accepts terms and conditions")
